...
pour le comportement actuel. PR 2 (§4.4) et PR 3 (§4.2, variante compteurs) évaluées et
**écartées** après mesure (code absent de `master`, raisonnement et chiffres conservés dans
chaque section). Les pistes 4 à 9 (dont la variante « partition de l'arène » de §4.2)
