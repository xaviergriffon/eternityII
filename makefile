...
TEST_SUITES_COMMON := \
                ...
                tests/net/test_etii_protocol.c tests/net/test_control_protocol.c tests/net/test_local_socket.c tests/net/test_tcp.c tests/net/test_http_codec.c tests/net/test_http_server.c \
...
TEST_MODULES := src/core/lifo.c src/core/part.c src/core/readdata.c src/ui/command_history.c src/ui/command_match.c src/ui/line_edit.c src/core/possibility.c src/core/best_board.c src/net/etii_protocol.c src/net/control_protocol.c src/net/http_codec.c src/net/http_server.c src/core/datamanager.c src/net/local_socket.c src/net/tcpclient.c src/net/tcpserver.c src/ui/command_lines.c src/ui/console.c src/ui/logger.c src/app/static_variables.c src/app/etii_client.c src/app/etii_server.c src/app/control_registry.c src/app/app_runtime.c src/app/etii_control.c
