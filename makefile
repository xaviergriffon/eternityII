...
TEST_SRCS    := tests/test_main.c tests/test_lifo.c tests/test_part.c tests/test_readdata.c tests/test_command_history.c tests/test_possibility.c tests/test_etii_protocol.c tests/test_command_match.c tests/test_datamanager.c tests/test_local_socket.c tests/test_tcp.c tests/test_logger.c
