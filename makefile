...
OBJS := \
	...
	$(BUILD_DIR)/core/core_static_variables.o \
	$(BUILD_DIR)/app/app_static_variables.o \
	...
	$(BUILD_DIR)/net/client_identity.o \
	$(BUILD_DIR)/net/control_protocol.o \
	$(BUILD_DIR)/net/http_codec.o \
	$(BUILD_DIR)/net/http_server.o \
	$(BUILD_DIR)/app/etii_client.o \
	$(BUILD_DIR)/app/etii_server.o \
	$(BUILD_DIR)/app/etii_control.o \
	$(BUILD_DIR)/app/control_registry.o \
	$(BUILD_DIR)/app/known_clients_registry.o \
	$(BUILD_DIR)/app/client_config.o \
	$(BUILD_DIR)/app/server_config.o \
	$(BUILD_DIR)/app/app_runtime.o \
	$(BUILD_DIR)/app/fork_gate.o \
	$(BUILD_DIR)/app/fork_orchestrator.o \
	$(BUILD_DIR)/core/etii_search.o \
	$(BUILD_DIR)/ui/command_lines.o \
	$(BUILD_DIR)/ui/command_match.o \
	$(BUILD_DIR)/ui/command_history.o \
	$(BUILD_DIR)/ui/line_edit.o \
...
$(BUILD_DIR)/app/gpu_pruner.o: src/app/gpu_pruner.cu src/app/gpu_pruner.h src/core/possibility.h src/core/part.h src/core/core_static_variables.h src/app/app_static_variables.h src/ui/logger.h
	@mkdir -p $(dir $@)
...
TEST_SUITES_COMMON := \
                tests/core/test_lifo.c tests/core/test_part.c tests/core/test_readdata.c tests/core/test_possibility.c tests/core/test_etii_search.c tests/core/test_datamanager.c tests/core/test_best_board.c tests/core/test_stock_spill.c tests/core/test_stock_rate.c \
                ...
                tests/tools/test_root_from_board.c tests/tools/test_border_walk.c tests/tools/test_border_ring_dp.c
...
TEST_MODULES := src/core/lifo.c src/core/part.c src/core/readdata.c src/ui/command_history.c src/ui/command_match.c src/ui/line_edit.c src/core/possibility.c src/core/best_board.c src/net/etii_protocol.c src/net/client_identity.c src/net/control_protocol.c src/net/http_codec.c src/net/http_server.c src/core/datamanager.c src/core/stock_spill.c src/core/stock_rate.c src/net/local_socket.c src/net/tcpclient.c src/net/tcpserver.c src/ui/command_lines.c src/ui/console.c src/ui/logger.c src/core/core_static_variables.c src/app/app_static_variables.c src/app/client_config.c src/app/server_config.c src/app/etii_client.c src/app/etii_server.c src/app/control_registry.c src/app/known_clients_registry.c src/app/app_runtime.c src/app/etii_control.c src/app/fork_gate.c src/app/fork_orchestrator.c tests/tools/root_from_board.c tests/tools/border_walk.c tests/tools/border_ring_dp.c tests/tools/ring_codec.c
