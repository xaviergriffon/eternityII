...
- Les égalités du balayage MRV (même score, même nombre de côtés contraints) sont départagées par un **poids d'échec appris** : chaque refus du forward-check compte un échec sur la case morte et sur la case posée, et la case qui a le plus souvent tué une branche est essayée d'abord. Mesuré sur les 418 racines ≥ 130 pièces d'un stock de production (`make bench-refutation`, plafond 2 M de nœuds) : **410 sous-arbres fermés contre 378, −79,6 % de nœuds** sur les racines fermées par les deux ; l'ordre positionnel qu'il remplace perdait déjà contre un tirage aléatoire (−37 à −56 %), et le sens inverse coûte +210 %. Voir [docs/conception/elagage_recherche.md](docs/conception/elagage_recherche.md) §4.14.
