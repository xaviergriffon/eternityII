 ...
 */
#include "greatest.h"
#include "../etii_client.h"   /* client_possibility_t */
#include "../lifo.h"          /* File, big_table */
#include "../datamanager.h"   /* datas_size, get_last_possibility */
#include "../possibility.h"
#include "../static_variables.h" /* max_stock_by_thread */
