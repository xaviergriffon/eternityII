...
Suite layout, `fork_assert.h` (for testing `exit()`-calling code without killing the runner), hand-built fixtures, coverage artefacts, the Docker/ARM cross-compile targets, and both benchmark harnesses: [docs/tests_et_ci.md](docs/tests_et_ci.md) and [tests/README.md](tests/README.md).
